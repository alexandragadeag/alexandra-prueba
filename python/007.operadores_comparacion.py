...
print(password != input_password) # son distintas
print(password == input_password) # son iguales 

if password != input_password:
    print('Contraseña incorrecta.')
    
respuesta_correcta = "Madrid"
respuesta_usuario = input("¿Cuál e la capital de España? ")
print(respuesta_correcta != respuesta_usuario)
print(respuesta_correcta == respuesta_usuario)
