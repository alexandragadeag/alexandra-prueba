public class BucleWhile {
    ...
    public static void main(String[] args) {
       ...
       // Ulitilizar bucle para encontrar a Wally, detener el bucle al encontrarlo 
       String[] nombres = {"Juan", "Alexandra", "Wally", "Bob"};

       // boolean found
       // while break
       // The local variable encontrado may not have been initialized
       ...
       while (count < nombres.length) {
           ...
           System.out.println(nombres[count] + " igual a Wally es " + resultado);
